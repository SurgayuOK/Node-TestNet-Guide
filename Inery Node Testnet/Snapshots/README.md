...
- Our Snapshot : https://inery.sarjananode.studio/snapshots/
_________________________
## Persiapan Utama
### 1. Stop Node Inery
```
...
- https://inery.sarjananode.studio/snapshots/
...
```
### 3. Download Snapshot
Silahkan ganti Link_Snapshot dengan link snapshot terbaru https://snapshot.inery.io/
```
