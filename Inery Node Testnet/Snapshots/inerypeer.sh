...
# Stop Node
cd $HOME/inery-node/inery.setup/master.node && ./stop.sh && sleep 2

# Pkill nodine
cd $HOME/inery-node/inery.setup/master.node && pkill nodine; pkill nodine; pkill nodine; pidof nodine
...
# Restart Node
cd $HOME/inery-node/inery.setup/master.node && ./genesis_start.sh && sleep 3; ./start.sh
